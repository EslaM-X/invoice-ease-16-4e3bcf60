-- Add paid_amount column to invoices to support customizable paid/remaining split
ALTER TABLE public.invoices
ADD COLUMN IF NOT EXISTS paid_amount numeric;

-- Update create_invoice RPC to accept optional paid amount
...
BEGIN
  ...
  -- Determine paid amount: explicit value if provided & valid, else 50% default
  ...
  UPDATE public.invoices SET subtotal = v_subtotal, total = v_total, paid_amount = v_paid WHERE id = v_invoice_id;
...
-- Update update_invoice RPC similarly
