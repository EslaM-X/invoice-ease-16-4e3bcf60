...
BEGIN
  ...
  -- Hard stop only for truly inactive invoice records.
  ...
  -- Out-for-delivery receipts mean the invoice is still open/in transit.
  SELECT
  ...
  -- Legacy safety: do not reopen old delivered invoices unless there is an active
  -- out-for-delivery receipt proving they are not actually signed/received yet.
