...
const ar: Dict = {
  ...
  supplier: "المورد",
  invoice_reference: "رقم الفاتورة / المرجع",
  pricing_mode_per_unit: "سعر لكل وحدة",
  pricing_mode_bulk: "سعر إجمالي للشحنة",
  bulk_total_label: "إجمالي تكلفة الشحنة",
  unit_cost: "تكلفة الوحدة",
  add_line: "إضافة سطر",
  intake_saved: "تم تسجيل الشحنة وتحديث المخزون",
  intake_history: "سجل الاستلامات",
  intake_number: "رقم الاستلام",
  total_units: "إجمالي القطع",
  total_cost: "إجمالي التكلفة",
  previous_avg: "المتوسط السابق",
  new_avg_cost: "المتوسط الجديد",
  no_intakes: "لا توجد استلامات بعد",
  remove: "حذف",
  ...
  closed_invoices: "فواتير مُغلقة",
  partial_delivery_invoices: "تسليم جزئي",
  ...
  team_chat: "شات الفريق",
  whatsapp_inbox: "واتساب",
  ...
  sort_total_desc: "الأعلى قيمة",
  sort_total_asc: "الأقل قيمة",
  showing_count: "عرض {n} من {m} فاتورة",
  selected_count: "تم تحديد {n} فاتورة",
  export_orders_style: "تصدير Excel (نمط الطلبات)",
  clear_selection: "إلغاء التحديد",
  select_all_aria: "تحديد الكل",
  select_invoice_aria: "تحديد الفاتورة",
  convert_to_draft: "تحويل لمسودة",
  convert_to_draft_confirm: "سيتم إرجاع المنتجات للمخزون وتحويل الفاتورة لمسودة. هل تريد المتابعة؟",
  invoice_converted_to_draft: "تم تحويل الفاتورة لمسودة",
  drafts: "المسودات",
  archive: "الأرشيف",
  hide_closed_invoices: "إخفاء الفواتير المُغلقة (مدفوعة + مُسلَّمة)",
...
const en: Dict = {
  ...
  pricing_mode_per_unit: "Per-unit price",
  pricing_mode_bulk: "Single bulk price",
  bulk_total_label: "Total shipment cost",
  unit_cost: "Unit cost",
  add_line: "Add line",
  intake_saved: "Intake recorded and stock updated",
  intake_history: "Intake history",
  intake_number: "Intake #",
  total_units: "Total units",
  total_cost: "Total cost",
  previous_avg: "Previous avg",
  new_avg_cost: "New avg cost",
  no_intakes: "No intakes yet",
  remove: "Remove",
  ...
  partial_delivery_invoices: "Partially delivered",
  ...
  system_notes_hint: "Internal notes — never printed on the invoice",
  invoices_with_system_notes: "Invoices with system notes",
  search_invoice_or_name: "Search by invoice # or customer name",
  ...
  showing_count: "Showing {n} of {m} invoices",
  selected_count: "{n} invoices selected",
  export_orders_style: "Export Excel (orders style)",
  clear_selection: "Clear selection",
  select_all_aria: "Select all",
  select_invoice_aria: "Select invoice",
  convert_to_draft: "Convert to draft",
  convert_to_draft_confirm: "Stock will be restored and the invoice will become a draft. Continue?",
  invoice_converted_to_draft: "Invoice converted to draft",
  drafts: "Drafts",
  archive: "Archive",
  hide_closed_invoices: "Hide closed invoices (paid + delivered)",
