...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Fira+Sans:wght@300;400;500;600;700&family=Cairo:wght@400;500;600;700;800&family=Amiri:wght@400;700&display=swap" },
