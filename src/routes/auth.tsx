        ...
        <div className="rounded-2xl border bg-card p-6 shadow-elegant">
          <div className="mb-5 flex gap-1 rounded-lg bg-muted p-1">
            <button
              ...
              className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition ${mode === "login" ? "bg-card shadow-sm" : "text-muted-foreground"}`}
            >{t("login")}</button>
            <button
              onClick={() => setMode("signup")}
              className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition ${mode === "signup" ? "bg-card shadow-sm" : "text-muted-foreground"}`}
            >{t("signup")}</button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" disabled={busy} className="w-full">{mode === "login" ? t("login") : t("signup")}</Button>
          </form>
